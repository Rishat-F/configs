...
let g:mapleader=','  " Change leader key
set mouse=n  " Enable mouse for resizing windows and focus windows in clicked position 
set encoding=utf-8
set number
set relativenumber
set noswapfile
...
" Disable ruby warning for nvim's ':checkhealth' command
let g:loaded_ruby_provider = 0

" Disable node.js warning for nvim's ':checkhealth' command
let g:loaded_node_provider = 0

" Disable perl warning for nvim's ':checkhealth' command
let g:loaded_perl_provider = 0


" Telescope bindings using Lua functions
...
" run current script with python3 by CTRL+P in command and insert mode
